...
scp.timing.txset-to-unblock-lag           | timer     | sub-interval of ballot-blocked-on-txset after the txset arrived: time from txset arrival to balloting committing it (the re-drive dead time; the remainder is the unavoidable wait for the txset)
