...
struct ValidatorWeightConfig
{
    ...
    UnorderedMap<std::string, size_t> mHomeDomainSizes;

    // Highest quality level of any validator in the config
    ValidatorQuality mHighestQuality;
};
...
class Config : public std::enable_shared_from_this<Config>
{
  ...
  public:
    ...
    // Revert to the old, application-agnostic weight function for SCP leader
    // election.
    bool FORCE_APPLICATION_AGNOSTIC_WEIGHT_FUNCTION;
